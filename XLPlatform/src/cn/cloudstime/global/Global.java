...
public  class Global {
	...
	public static Map<String,BusinessUserBalanceBean> BUSINESS_USER_BALANCE=new HashMap<String, BusinessUserBalanceBean>();
	
	public static Map<String,Integer> BUSINESS_USER_STATE=new HashMap<String,Integer>();

	public static Map<String,Long> BUSINESS_USER_ALERT_BALANCE=new HashMap<String,Long>();
	
	public static Map<String,JSONObject> PLATFORM_INFO=new HashMap<String,JSONObject>();
	...
	public static Map<String,JSONObject> NUMBER_RULES=new HashMap<String,JSONObject>();
	...
	public static Integer TRANSACTION_THREAD_COUNT=100;
	
	public static Integer OUTPUT_THREAD_COUNT=100;
	
	public static Integer RESPONSE_THREAD_COUNT=100;
	
	public static Integer lOG_THREAD_COUNT=100;
	
	public static Integer EXCEPTION_THREAD_COUNT=10;
	
	public static Integer NOTIFY_THREAD_COUNT=50;
	
	
    public static Long TRANSACTION_THREAD_SLEEPTIME=200L;
	
	public static Long OUTPUT_THREAD_SLEEPTIME=200L;
	
	public static Long RESPONSE_THREAD_SLEEPTIME=200L;
	
	public static Long lOG_THREAD_SLEEPTIME=200L;
	
	public static Long EXCEPTION_THREAD_SLEEPTIME=200L;
	
	public static Long NOTIFY_THREAD_SLEEPTIME=200L;
	...
	public  static  Integer CURRENT_ORDER_NO=1;
